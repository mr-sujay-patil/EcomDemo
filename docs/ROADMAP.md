...
| 21 | API Gateway (Spring Cloud Gateway) | Distributed | ⬜ Not started — unsupported-but-working version combination, verified; see `docs/decisions.md` |
| 22 | Resilience (Resilience4j) | Distributed | ✅ Complete |
