...
class CartControllerTest {
    ...
    void view_whenTheCartHasItems_returns200WithTheServerCalculatedTotal() {
        // GIVEN
        given(cartService.getCart()).willReturn(cartWithOneKeyboard());
    ...
    void addItem_withAValidBody_returns200WithTheUpdatedCart() {
        // GIVEN
        given(cartService.addItem(any(AddCartItemRequest.class))).willReturn(cartWithOneKeyboard());
    ...
    void updateItem_withAValidQuantity_returns200() {
        // GIVEN
        given(cartService.updateItemQuantity(eq(1L), any(UpdateCartItemRequest.class)))
    ...
    void updateItem_whenTheLineIsNotInTheCart_returns404() {
        // GIVEN
        given(cartService.updateItemQuantity(eq(42L), any()))
    ...
    void removeItem_whenTheLineExists_returns200WithTheRemainingCart() {
        // GIVEN
        given(cartService.removeItem(1L)).willReturn(new CartResponse(1L, List.of(), 0, BigDecimal.ZERO));
